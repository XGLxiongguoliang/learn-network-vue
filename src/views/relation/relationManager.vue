<template>
    <div>
        ...
        <el-table :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))"
            ...
            <el-table-column width="500">
                <template slot="header" slot-scope="scope">
                    ...
                    <el-button type="success" @click="addRelation()">新增</el-button>
                </template>
                <template slot-scope="scope">
                    <el-button size="mini" @click="editRelation(scope.row)">Edit</el-button>
        ...
        <el-dialog title="添加关系" :visible.sync="outerVisible" @close="close">
            <el-form :model="form">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="addRelationForm()">确认</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
<script>
    export default {
        ...
        methods: {
            ...
            getAllRelation () {
                this.clearTable();
                this.$api.post('/api/relation/getRelationList', this.queryParam).then(response => {
            ...
            handleDelete(row) {
                let ids = [row.id];
                this.$api.post('/api/relation/deleteRelation', ids).then(response => {
                    this.getAllRelation();
                })
            },
            batchDelete() {
            ...
            addRelationForm() {
                this.$api.post('/api/relation/addRelation/',{
                    id: this.form.id,
                    name: this.form.name,
                }).then(response => {
